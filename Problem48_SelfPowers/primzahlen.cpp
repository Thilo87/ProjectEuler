...
unsigned long long binModExponentiation( unsigned long long basis, unsigned long long exponent, unsigned long long modul )
{
	...
	{
		unsigned long long ziffer = exponent_kopie % 2LL ;
		if ( ziffer == 1 )
